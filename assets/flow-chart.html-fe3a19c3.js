import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o,c as e,a as n,d as s,b as r,e as c}from"./app-908acf4f.js";const u={},i=n("h1",{id:"flowchart",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#flowchart","aria-hidden":"true"},"#"),s(" FlowChart")],-1),l=n("code",null,"didi/LogicFlow",-1),k={href:"http://logic-flow.org/guide/start.html",target:"_blank",rel:"noopener noreferrer"},d=c(`<h2 id="usage" tabindex="-1"><a class="header-anchor" href="#usage" aria-hidden="true">#</a> Usage</h2><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">&gt;</span></span>
