import{_ as t,X as p,Y as o,Z as s,a0 as n,$ as e,a2 as c,F as i}from"./framework-13746272.js";const l={},r=s("h1",{id:"菜单",tabindex:"-1"},[s("a",{class:"header-anchor",href:"#菜单","aria-hidden":"true"},"#"),n(" 菜单")],-1),u={href:"https://github.com/vbenjs/vue-vben-admin/tree/main/src/router/menus",target:"_blank",rel:"noopener noreferrer"},d=c(`<div class="hint-container tip"><p class="hint-container-title">提示</p><p>菜单必须和路由匹配才能显示</p></div><h2 id="菜单项类型" tabindex="-1"><a class="header-anchor" href="#菜单项类型" aria-hidden="true">#</a> 菜单项类型</h2><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">interface</span> <span class="token class-name">Menu</span> <span class="token punctuation">{</span>
