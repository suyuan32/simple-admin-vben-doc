...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,6);function k(v,m){const t=i("ExternalLinkIcon");return e(),o("div",null,[l,n("p",null,[s("Code address: "),n("a",d,[s("src/components/registerGlobComp.ts"),c(t)])]),r])}const g=p(u,[["render",k],["__file","7-component.html.vue"]]);export{g as default};
