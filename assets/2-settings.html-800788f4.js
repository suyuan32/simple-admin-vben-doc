import{_ as o,W as p,X as i,Y as n,$ as s,Z as e,a1 as t,D as l}from"./framework-4a45a4a9.js";const c={},r=n("h1",{id:"project-configuration",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#project-configuration","aria-hidden":"true"},"#"),s(" Project Configuration")],-1),u=n("p",null,"Include color scheme, layout, caching, multi-language support, and default component configuration.",-1),d=n("h2",{id:"environment-variables-configuration",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#environment-variables-configuration","aria-hidden":"true"},"#"),s(" Environment Variables Configuration")],-1),m={href:"https://github.com/vbenjs/vue-vben-admin/blob/main/.env",target:"_blank",rel:"noopener noreferrer"},v={href:"https://github.com/vbenjs/vue-vben-admin/blob/main/.env.development",target:"_blank",rel:"noopener noreferrer"},k={href:"https://github.com/vbenjs/vue-vben-admin/blob/main/.env.production",target:"_blank",rel:"noopener noreferrer"},b={href:"https://github.com/vitejs/vite#modes-and-environment-variables",target:"_blank",rel:"noopener noreferrer"},h=t(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>.env                <span class="token comment"># Loaded in all environments</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="project-configuration-1" tabindex="-1"><a class="header-anchor" href="#project-configuration-1" aria-hidden="true">#</a> Project Configuration</h2><div class="hint-container warning"><p class="hint-container-title">Note</p><p>The project configuration file is used to configure the content, layout, text and other effects displayed in the project and is stored in <code>localStorage</code>. If the project configuration is changed, you need to manually <strong>clear</strong> the <code>localStorage</code> cache and refresh and log in again to take effect.</p></div><h3 id="configuration-file-path" tabindex="-1"><a class="header-anchor" href="#configuration-file-path" aria-hidden="true">#</a> Configuration file path</h3>`,4),x={href:"https://github.com/vbenjs/vue-vben-admin/tree/main/src/settings/projectSetting.ts",target:"_blank",rel:"noopener noreferrer"},q=t(`<p>Here is the English translation of your text in markdown:</p><h3 id="description-1" tabindex="-1"><a class="header-anchor" href="#description-1" aria-hidden="true">#</a> Description</h3><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// ! You need to clear your browser cache after making changes</span>
